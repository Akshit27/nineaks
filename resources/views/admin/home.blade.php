            ...
            <div class="col-md-4">
              <div class="card">
                ...
                <div class="card-body pb-0">
                  <div class="d-flex">
                    <div class="avatar">
                      <img src="http://demo.themekita.com/atlantis/livepreview/examples/{{asset('admin')}}/img/logoproduct.svg" alt="..." class="avatar-img rounded-circle">
                    </div>
                  ...
                  <div class="d-flex">
                    <div class="avatar">
                      <img src="http://demo.themekita.com/atlantis/livepreview/examples/{{asset('admin')}}/img/logoproduct3.svg" alt="..." class="avatar-img rounded-circle">
                    </div>
                    <div class="flex-1 pt-1 ml-2">
